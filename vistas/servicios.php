...
<div class="contenedor">
    ...
    <div class="nav">
      <ul>
        ...
        <a id="select" href="servicios.php">SERVICIOS</a>
        <a href="contacto.php">CONTACTO</a>
      </ul>
    </div>

    <h1 class="text-center" style="margin-top: 5%;">La Rivera | Empresa Constructora</h1>
    <p class="tit">Nuestros servicios</p>
      <br><br>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            ...
            <h3 class="text-center">Chalets</h3>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <h3 class="text-center">Naves Industriales</h3>
            <!-- <p>Lorem ipsum dolor sit amet, consectetur adipisici elit,&nbsp;</p> -->
          </div>
          <div class="col-md-4">
            <figure class="imgs6">
            ...
            <h2 class="text-center">Comercios</h2>
            <!-- <p>Lorem ipsum dolor sit amet, consectetur adipisici elit,&nbsp;</p> -->
          </div>
        </div>
      </div>
